...
// std::sqrt(1/(1-0.9*s))*
	// Boyle Thesis eqn (8.14)
	//if( propFeedback[S] < temp_thd  ) /**/ { Switch[0][S] = 1;} else {Switch[0][S] = 0;} 
	//if( propFeedback[S] > temp_thv  ) /**/ { Switch[1][S] = 1;} else {Switch[1][S] = 0;} // TODO Think hard about signs here (differs from Boyles model)
